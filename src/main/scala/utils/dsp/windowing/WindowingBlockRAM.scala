...
class AXI4WindowingBlockRAM[T <: Data: Real: BinaryRepresentation](
  ...
  lazy val module = new LazyModuleImp(this) {
    ...
    when(r_addr_reg === (numPoints - 1.U) && in.fire) {
      r_addr_reg := 0.U
    }
