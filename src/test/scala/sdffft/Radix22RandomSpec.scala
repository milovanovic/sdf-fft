...
//  */
//
//class Radix22RandomSpec extends AnyFlatSpec with Matchers {
//
//  val numSamples = 2
...
//        dsptools.Driver.execute(() => new SDFFFT(paramsFixed16s), Array("-tbn", backendName)) { c =>
...
//        dsptools.Driver.execute(() => new SDFFFT(paramsFixed24s), Array("-tbn", backendName)) { c =>
//          new FixedPointSDFFFTTester(c) {
//            var count = 0
//            while (count < numSamples) {
//              val testSignal = genRandSignal(i, i)
...
//        dsptools.Driver.execute(() => new SDFFFT(paramsFixed16g), Array("-tbn", backendName)) { c =>
//          new FixedPointSDFFFTTester(c) {
//            var count = 0
//            while (count < numSamples) {
//              val testSignal = genRandSignal(i, i)
...
//        dsptools.Driver.execute(() => new SDFFFT(paramsFixed24g), Array("-tbn", backendName)) { c =>
//          new FixedPointSDFFFTTester(c) {
//            var count = 0
//            while (count < numSamples) {
//              val testSignal = genRandSignal(i, i)
